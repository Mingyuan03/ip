...
import shinpaimax.command.Command;
import shinpaimax.command.CommandProcessor;
import shinpaimax.command.HelpCommand;
import shinpaimax.exception.InvalidCommandException;
import shinpaimax.exception.ShinpaiMaxException;
 ...
 * ShinpaiMax is a wordplay on the nostalgic childhood Disney character BayMax, where shinpai means care in Japanese.
 * @author Lu Mingyuan
 * @version v1.0.0-alpha
 */
public class ShinpaiMax {
    ...
    public String[] processCommandByMap(String rawInput) {
        try {
            ...
            // Separation of concern for this exception vs ShinpaiMaxException subclasses for more scalability lest
